      ...
      <div className="space-y-8">
        ...
        <div className="flex justify-center items-center gap-12 mb-8">
          <div className="text-center">
            <div className="w-48 h-16 bg-gradient-to-r from-orange-500 to-red-600 rounded-lg flex items-center justify-center mb-2">
              <span className="text-white font-bold text-lg">EventForce</span>
            </div>
            <div className="text-orange-600 font-semibold text-sm">Technology Platform</div>
          </div>
          <div className="text-4xl text-gray-400">+</div>
          <div className="text-center">
            <div className="w-24 h-24 bg-gradient-to-r from-green-500 to-blue-600 rounded-full flex items-center justify-center mb-2">
              <span className="text-white font-bold text-xl">V</span>
            </div>
            <div className="font-bold text-gray-800">veloscope</div>
            <div className="text-green-600 font-semibold text-sm">Creative Solutions</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <h3 className="text-xl font-bold mb-3 text-gray-800">Current Partnership</h3>
            <p className="text-gray-600 leading-relaxed">Successfully managing photography and videography for Maha Marathon series across Maharashtra</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-bold mb-3 text-gray-800">Next Evolution</h3>
            <p className="text-gray-600 leading-relaxed">Introducing comprehensive event management platform with AI-powered solutions</p>
          </motion.div>
          ...
          >
            <div className="text-5xl mb-4">🎯</div>
            <h3 className="text-xl font-bold mb-3 text-gray-800">Complete Solution</h3>
            <p className="text-gray-600 leading-relaxed">From registration to post-event engagement - all in one integrated platform</p>
          </motion.div>
        </div>
        ...
        >
          <h3 className="text-2xl font-bold mb-4">Ready to revolutionize your event management?</h3>
          <p className="text-lg opacity-90">Let's take Maha Marathon to the next level with cutting-edge technology and creative excellence</p>
        </motion.div>
      </div>
    )
  },
