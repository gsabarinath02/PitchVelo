...
const slides = [
  {
    ...
    content: (
      <div className="space-y-4 sm:space-y-6 lg:space-y-8">
        {/* Logo Section */}
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-8 lg:gap-12 mb-4 sm:mb-6 lg:mb-8">
          <div className="text-center">
            <div className="w-32 sm:w-40 lg:w-48 h-12 sm:h-14 lg:h-16 bg-gradient-to-r from-orange-500 to-red-600 rounded-lg flex items-center justify-center mb-2">
              <span className="text-white font-bold text-sm sm:text-base lg:text-lg">EventForce</span>
            </div>
          ...
          <div className="text-center">
            <div className="w-16 sm:w-20 lg:w-24 h-16 sm:h-20 lg:h-24 bg-gradient-to-r from-green-500 to-blue-600 rounded-full flex items-center justify-center mb-2">
              <span className="text-white font-bold text-sm sm:text-base lg:text-xl">V</span>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          <motion.div 
            ...
            whileHover={{ y: -5 }}
          >
            <div className="text-3xl sm:text-4xl lg:text-5xl mb-2 sm:mb-4">🏃‍♂️</div>
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-800">Current Partnership</h3>
            <p className="text-gray-600 leading-relaxed text-sm sm:text-base">Successfully managing photography and videography for Maha Marathon series across Maharashtra</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-800">Next Evolution</h3>
            <p className="text-gray-600 leading-relaxed text-sm sm:text-base">Introducing comprehensive event management platform with AI-powered solutions</p>
          </motion.div>
          ...
          >
            <div className="text-3xl sm:text-4xl lg:text-5xl mb-2 sm:mb-4">🎯</div>
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-800">Complete Solution</h3>
            <p className="text-gray-600 leading-relaxed text-sm sm:text-base">From registration to post-event engagement - all in one integrated platform</p>
          </motion.div>
        </div>

        <motion.div 
          className="bg-gradient-to-r from-blue-600 to-purple-700 text-white p-4 sm:p-6 lg:p-8 rounded-2xl text-center"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.5 }}
        >
          <h3 className="text-lg sm:text-xl lg:text-2xl font-bold mb-2 sm:mb-4">Ready to revolutionize your event management?</h3>
          <p className="text-sm sm:text-base lg:text-lg opacity-90">Let's take Maha Marathon to the next level with cutting-edge technology and creative excellence</p>
        </motion.div>
      </div>
    )
  },
    ...
    content: (
      <div className="space-y-8">
        ...
        <div className="flex justify-center mb-8">
          <div className="w-48 h-16 bg-gradient-to-r from-orange-500 to-red-600 rounded-lg flex items-center justify-center">
            <span className="text-white font-bold text-lg">EventForce</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <h3 className="text-xl font-bold mb-3 text-gray-800">Smart Registration System</h3>
            <p className="text-gray-600 leading-relaxed">Seamless participant registration with payment gateway integration. Only <span className="font-bold text-green-600">₹10 per participant</span> for EventForce subscribers vs ₹25 for regular users</p>
          </motion.div>
          ...
          >
            <div className="text-4xl mb-4">🤖</div>
            <h3 className="text-xl font-bold mb-3 text-gray-800">AI-Powered Support Desk</h3>
            <p className="text-gray-600 leading-relaxed">24/7 automated customer support with intelligent query resolution and escalation to human agents when needed</p>
          </motion.div>
          ...
          >
            <div className="text-4xl mb-4">💬</div>
            <h3 className="text-xl font-bold mb-3 text-gray-800">Omni-Channel Messaging</h3>
            <p className="text-gray-600 leading-relaxed">Unified console for WhatsApp, SMS, Email, Facebook, Instagram with hyper-personalized messaging and campaign tracking</p>
          </motion.div>
          ...
          >
            <div className="text-4xl mb-4">📊</div>
            <h3 className="text-xl font-bold mb-3 text-gray-800">Customer Data Platform</h3>
            <p className="text-gray-600 leading-relaxed">Advanced CRM with participant history, performance analytics, and pre-built query filters for targeted engagement</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-bold mb-3 text-gray-800">Secure Cloud Storage</h3>
            <p className="text-gray-600 leading-relaxed">3TB storage for all event data with easy access, classification, and retrieval through a unified interface</p>
          </motion.div>
          ...
          >
            <div className="text-4xl mb-4">📈</div>
            <h3 className="text-xl font-bold mb-3 text-gray-800">Real-time Dashboards</h3>
            <p className="text-gray-600 leading-relaxed">Event-specific status dashboards with role-based access for efficient task management and decision making</p>
          </motion.div>
        </div>
      </div>
    )
  },
  {
    ...
    content: (
      <div className="space-y-8">
        ...
        <div className="flex justify-center mb-8">
          <div className="text-center">
            <div className="w-24 h-24 bg-gradient-to-r from-green-500 to-blue-600 rounded-full flex items-center justify-center mb-3">
      ...
      <div className="relative">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="card min-h-[400px] sm:min-h-[500px] lg:min-h-[600px]"
          >
            <div className="text-center mb-4 sm:mb-6 lg:mb-8">
              <motion.h1 
                className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 mb-2 sm:mb-4 bg-gradient-to-r from-blue-600 to-purple-700 bg-clip-text text-transparent"
                initial={{ opacity: 0, y: -20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.2 }}
              >
